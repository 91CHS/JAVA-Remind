...
public class ArrayMain1 {
	...
	public static void main(String[] args) {
		...
		// 1) 배열의 메모리주소
		System.out.println(scores);              // 메모리주소 : 16진수           [I@5594a1b5
		System.out.println(scores.hashCode());   // 메모리주소 : 10진수           1435804085
		System.out.println(scores.toString());   // 메모리주소 : 문자열(15진수)    [I@5594a1b5
		System.out.println();
		
		// 2) index
		System.out.println("scores[0] = " + scores[0]);   //90
		System.out.println("scores[1] = " + scores[1]);   //95
		System.out.println("scores[5] = " + scores[5]);   //100
		System.out.println();
		...
		// for : scores[0] = " "  이런 식으로  scores[0] ~ 12를 각각 출력하고
		// 총점 = ???, 평균 = ???
		int sum = 0;
