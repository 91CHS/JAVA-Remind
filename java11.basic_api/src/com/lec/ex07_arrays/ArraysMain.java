...
/*
	...
	Arrays클래스는 배여렝 관한 조작기능을 가지고 있다. 배열의 복사, 항목의 정렬,
...
public class ArraysMain {
	...
	public static void main(String[] args) {
		...
		// 3. 객체의 정렬 및 검색
		// 객체를 정렬하려면 Comparable인터페이스의 후상메서드인 compareTo()메서드를
		// 재정의해야한다. 만약 Comparable인터페이스를 구현하지 않고 정렬을 하려면
		...
		System.out.println("이강인의 위치 : " + index + " = " + members[index]);
		System.out.println();
...
class Member implements Comparable<Member> {
	...
	public int compareTo(Member o) {
		return this.name.compareTo(o.name); // this가 String타입이라서 가능하다
	}
