...
/*
 	...
 	1. Class객체얻기(Class.forName(String str), Object.getClass(클래스이름))
 		...
 		1) Object클래스이 getClass()메서드와
 		2) Class클래스의 forName()메서드를 이용한다.
 		
 		Object는 모든 클래스의 최상위 클래스이므로 모든 클래스에 getClass()메서드를
 		호출할 수가 있다. getClass()메서드는 해당 클래스의 객체가 생성되어 있을 때만
 		사용할 수 있지만 객체가 생성되어 있지 않다면 class객체를 얻을 수가 없다.
...
public class ClassMain {
	...
	public static void main(String[] args) {
		...
		// 3. forName()
//			Class car3 = Class.forName("com.lec.ex04_class.Car");  // 예외처리 해야함
			try {
