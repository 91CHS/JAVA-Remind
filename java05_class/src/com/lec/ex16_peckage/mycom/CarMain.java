package com.lec.ex16_peckage.mycom;


import com.lec.ex16_peckage.hankook.SnowTire;
import com.lec.ex16_peckage.hyundai.Engine;
import com.lec.ex16_peckage.kumho.BigWidthTire;
/*
  패키지(package)
  ...
  기능만 하는 것이 아니라 "클래스 이름의 일부분"이다. 즉 클래스이름은 패키지명을 포함한
  클래스파일명 전체가 클래스 이름이다.
...
public class CarMain {
	...
	public static void main(String[] args) {
		...
		com.lec.ex16_peckage.hankook.Tire ft = new com.lec.ex16_peckage.hankook.Tire();
		com.lec.ex16_peckage.kumho.Tire bt = new com.lec.ex16_peckage.kumho.Tire();
...
class Car{
	com.lec.ex16_peckage.hankook.Tire flt;
	com.lec.ex16_peckage.hankook.Tire frt;
	SnowTire blt;
	BigWidthTire brt;
	Engine engine;
}