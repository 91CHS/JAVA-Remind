...
/*
  ...
  클래스멤버는 객체에 소속된 멤버가 아니기 때문에 객체가 생성되지 않아도 사용할 수 있다.
  인스턴스멤버는 반드시 객체가 생성된 후에 사용할 수 있다.
  
  클래스멤버의 접근은 "클래스명.정적멤버"로 접근하고 객체멤버는 "객체명.객체멤버"의 형태로 접근한다.
...
public class CarMain {
	...
	public static void main(String[] args) {
		...
		Car myCar = new Car();
		myCar.model="시빅";
		System.out.println("객체에서 정적멤버를 접근 : company =" + myCar.company);
		myCar.method1();
...
class Car {
	...
	static void method1 () {
		System.out.println("정적멤버 method1이 호출되었습니다.");
	}
	void method2 () {
		System.out.println("객체멤버 method2이 호출되었습니다.");
	}
