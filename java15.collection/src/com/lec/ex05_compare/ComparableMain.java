...
/*
	...
	인터페이스는 compareTo()추상메서드가 정의되어 있기 때문에 사용자가 정의하는 클래스도 Comparable을
...
class Person implements Comparable<Person> { //사용자가 정의한 클래스를 자동으로 정렬을 하고자할 경우에는 Comparable을 구현해야 한다.
