...
public class TreeMapMain1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("95미만 바로 아래 : " + student.getValue() + " = " + student.getKey());
		
		student = scores.higherEntry(95);
		System.out.println("95초과 바로 위 : " + student.getValue() + " = " + student.getKey());
		
		student = scores.floorEntry(95);
		System.out.println("95이하 바로 아래 : " + student.getValue() + " = " + student.getKey());
		
		student = scores.ceilingEntry(95);
		System.out.println("95이상 바로 위 : " + student.getValue() + " = " + student.getKey());
		
		while(!scores.isEmpty()) {
			student = scores.pollFirstEntry(); // 가장 낮은 객체를 꺼내온 후 삭제!!! 삭제!!!!!!!!!!!!!!!!!!!!!
